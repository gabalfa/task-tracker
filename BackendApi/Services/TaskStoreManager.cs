...
namespace BackendApi.Services
{
    public class TasksStoreManager : ITasksManager
    {
        ...
        public async Task<Guid> CreateNewTask(string taskName, string createdBy, string assignedTo, string dueDate)
        {
            ...
            await _daprClient.SaveStateAsync(STORE_NAME, taskModel.TaskId.ToString(), taskModel);
        ...
        public async Task<bool> UpdateTask(Guid taskId, string taskName, string assignedTo, string dueDate)
        {
